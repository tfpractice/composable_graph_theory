...
// let elemChecker = (elem) => element.type() === "nodetype"
// let arrayType = (tFunc) => tFunc(base);

// let altMixin = (eFunc) => {
//     let unaryFuncs = {
//         isValid: (elem) => validify(eFunc(elem))(kestrel(true))
//     }
// }
...
let baseMixin = (BaseClass) => {
    let unaryFuncs = composed(BaseClass);

    let curryFuncs = (context = []) => unaryFuncs;
