...
let addMethod = (curriedQ) => (context) => Object.assign(context, containify(curriedQ)(context));
let hideMethod = (curriedQ) => (context) => nonEnum(addMethod(curriedQ)(context))('contains');
