...
let contains = (sArr = []) => (argObj) => sArr.some(matchesArg(argObj));
let isSubset = (sArr = []) => (altArray) => subset(contains)(sArr)(altArray);

let isEquivalent = (sArr = []) => (altArray) => isSubset(sArr)(altArray) && isSubset(altArray)(sArr);

let findEquivalentElement = (sArr = []) => (argObj) => sArr.find(matchesArg(argObj));
