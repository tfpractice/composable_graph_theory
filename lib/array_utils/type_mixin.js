let newFrom = (instanceFunction) => (sArr = []) => (...args) =>
    instanceFunction(Array.from(...args));

let of = (instanceFunction) => (sArr = []) => (...args) =>
...
let concat = (instanceFunction) => (sArr = []) => (...args) =>
    instanceFunction(sArr.concat(...args));

let slice = (instanceFunction) => (sArr = []) => (...args) =>
    instanceFunction(sArr.slice(...args));

let splice = (instanceFunction) => (sArr = []) => (...args) =>
    instanceFunction(sArr.splice(...args));

let filter = (instanceFunction) => (sArr = []) => (...args) => (
...
let copy = (instanceFunction) => (sArr = []) => () => instanceFunction(
    sArr.slice(0));
// 
let removeElement = (instanceFunction) => (sArr = []);

let excludeElement = (instanceFunction) => (sArr = []) => (exel) =>
    instanceFunction(sArr.filter(e => e !== exel))
...
let typeMixin = (instanceFunction) => (sArr) => ({
    ...
    clear: () => clear(instanceFunction)(sArr),
    ...
    removeElement: (argObj) => {
        ...
        return eqIdx > -1 && splice(instanceFunction)(sArr)(eqIdx,
            1);
    }
});
