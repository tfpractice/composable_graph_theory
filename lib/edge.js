...
let slabelMaker = labelize.stateOps(lFunc);
let sweightMaker = weighable.stateOps(wFunc);
let stypeMaker = typify.stateOps(tFunc);
let pseudoFact = factory(slabelMaker, sweightMaker, stypeMaker);
// console.log(pseudoFact);
// let snodeMaker = nodify(nFunc);
...
let getNeighborArray = (nabe) => (edge) => getNeighbors(edge)(nabe);
...
// let EdgeMaker = factory(typeMaker, dataMaker, labelMaker, eqMaker);
...
module.exports = Edge;
module.exports.altEdge = pseudoFact;
...
module.exports.getNeighborArray = getNeighborArray;
