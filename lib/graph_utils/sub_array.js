...
let basicHooks = (BaseClass) => Object.assign({}, type_maker(BaseClass), base_type_maker(BaseClass), validator(valid_condition(BaseClass)));
...
let arrayOf = (BaseClass) => {
    ...
    let construct2 = (sArr = []) => Object.assign(Array.from(sArr), bHooks, tHooks(sArr), sHooks(sArr));
