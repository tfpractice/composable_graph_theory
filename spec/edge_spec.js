fdescribe('Edge', function() {
	...
	let e0, e1, e2, e3;
	let eState0, eState1, eState2, eState3;
	let aEdge0, aEdge1, aEdge2, aEdge3;
	let altEdge, nStruct, eStruct;
	beforeAll(function() {
		console.log('\n.........Edge Spec.........');
		Node = this.GR.Node;
		...
		Edge = this.GR.Edge;
		({ altEdge } = Edge);
		eStruct = (n0, n1, weight = 0) => ({ nodes: [n0, n1], weight });
	...
	// });
	// describe('label', () => {
	// it('returns the concatenated labels of each of the nodes', () => {
	...
	// it('returns a boolean based on the equality of the nodse', () => {
	// expect(e0.isEquivalent(e1)).toBeFalse();
	// expect(e0.isEquivalent(e0)).toBeTrue();
	// });
	// });
	// describe('containsNode', () => {
	// it('returns aboolean based on presence of node in nodes', () => {
	...
	// });
	// describe('nabeArray', () => {
	// it('returns an aray of elemnets that are not the node specified',
	// () => {
	...
	// it('returns a boolean describing the presence of a node ', () => {
	...
	// expect(Edge.hasSameNodes(e0)(e0))
	// .toBeTrue();
	// });
	// });
